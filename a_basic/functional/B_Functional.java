...
public class B_Functional {
     ...
     *    compare메소드와 같이 추상메서드가 하나인 경우는 가능하다.
...
//        };
        ...
        A_FuncInterface f1=()->System.out.println("매개변수와 반환값이 없는 람다식2");
        f1 = () -> {
    ...
    public void method2(){
        ...
        f1=(num)->System.out.println(100*num);
        f1=num->System.out.println(100*num);
        f1.method(500);
    }
    ...
    public void method3() {
        ...
        f1=(a,b)->a + b;
        f1=(a,b)->sum(a,b);
        System.out.println(f1.method(10,4));
    }
